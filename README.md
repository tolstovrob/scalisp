...
Что умеет язык? Проще посмотреть в исходный код. В пакете `evaluator` описаны специальные формы, а в пакете `builtins` &mdash; встроенные функции. Последние будут пополняться в дальнейшем.
